      ...
      <div class="mt-12 md:mt-24 bg-bgsecondary border border-gray-200 rounded-xl shadow-sm">
        <div class="p-4 sm:p-7">
          <div class="text-center">
            <h1 class="block text-2xl font-bold text-normal">Sign in</h1>
          ...
          <div class="mt-5">
              <div class="grid gap-y-4">
                ...
                <div class="flex items-center">
                  <div class="flex">
                    <input id="exampleCheck1" name="remember-me" type="checkbox" class="shrink-0 mt-0.5 border-gray-200 rounded text-blue-600 pointer-events-none focus:ring-blue-500">
                  </div>
                  <div class="ml-3">
