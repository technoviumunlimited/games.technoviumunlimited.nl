    ...
    <div class="bg-footer text-light text-lg font-bold mt-24">
        <div class="container mx-auto flex flex-col">
            <div class="py-16 space-y-4 flex flex-col md:flex-row gap-24 md:items-center flex-wrap gap-y-5">
                <div class="flex-1">
                    <p class="whitespace-pre-line">
                        Met Technovium Unlimited wordt gestreefd een levende online leeromgeving te creëren, 
                    </p>
                    <p>
            ...
            <div class="py-4 flex flex-row flex-wrap gap-y-5 justify-between items-center text-sm text-light font-bold">
                ...
                <span>In case of any concern, <a class="text-default hover:text-blue-700 font-black" href="mailto:b.dewildt@roc-nijmegen.nl,d.radic@roc-nijmegen.nl">contact us</a></span>
            </div>
        </div>
    </div>
</template>